...
public enum ColumnType {
	 ...
	 * 数字型
	 */
	INT("int", "整数型", new String[] { "tinyint", "number", "smallint", "mediumint", "int", "integer", "bigint"}),
	...
	public static ColumnType getByDbDataType(String dbDataType, String errMsgApp) {
		...
		throw new RuntimeException(String.format("[%s]数据库类型[%s]转换不了系统支持的类型", errMsgApp, dbDataType));
	}
